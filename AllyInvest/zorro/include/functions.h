...
int exitTrade(TRADE* tr,var Limit,int lots,...); // sell a particular trade position
...
int priceSet(int offset,var Open, var High, var Low, var Close);
int priceQuote(var Timestamp,var Quote);
...
var wdatef(string Format,string DateTime);
...
void shift(var* Data,var value,int length);
...
var markowitz(var* CovMatrix,var* Mean,int N,double *Caps);
...
// broker 
int brokerAsset(string AssetSymbol,var *pPrice,var *pSpread,var *pVol);
...
// data handling
int dataDownload(string Code,int Mode,int Period);
int dataParse(int Handle,string Format,string FileName);
void dataSave(int Handle,string FileName,int Start,int Num,...);
int dataLoad(int Handle,string FileName,int Fields);
float* dataNew(int Handle,int Records,int Fields);
void dataSort(int Handle);
int dataMerge(int Handle1,int Handle2);
int dataAppend(int Handle1,int Handle2,int Start,int Num,...);
int dataFind(int Handle,var Date);
var dataVar(int Handle,int Row,int Col);
int dataInt(int Handle,int Row,int Col);
string dataStr(int Handle,int Row,int Col);
void dataSet(int Handle,int Row,int Col,var Value);
...
// options
CONTRACT* contract(int Type,int Days,var Strike);
int contractUpdate(string Name,int Handle,int Mode);
var contractDays(CONTRACT* c);
var contractPrice(CONTRACT* c);
int contractPosition(CONTRACT* c);
int contractCheck(TRADE* tr);
